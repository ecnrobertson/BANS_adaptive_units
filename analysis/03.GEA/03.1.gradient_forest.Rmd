...
```{bash}
rsync -avzP /Users/ericarobertson/Desktop/BANS_adaptive_units/data/BANS_sample_list_pop.tsv ericacnr@colostate.edu@login.rc.colorado.edu:/scratch/alpine/ericacnr@colostate.edu/BANS/03.GEA/
```
...
# clim <- read_delim("BANS.initial.worldclim.landscape_edit.txt", delim = "\t") %>% 
...
I'm moving it back to my local computer to better visualize stuff.
```{bash}
...
ranked_predictors <- c("bio16", "bio02", "bio12", "bio17", "bioclay", "bio14", "bio13", "bio08", "bio10", "bio07", "bio05", "bio11", "bio04", "bio19", "bio06", "bio18", "bio01", "bio09", "biosand", "bio03")
