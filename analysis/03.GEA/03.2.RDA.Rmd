...
```{bash}
plink --bfile ../BANS.ds6x.maf.0.05.SNP.above4x.maxmiss.8.imputed4.1.ld25-10-0.5 --pca 208 --remove ../../ header --out BANS.ds6x.maf.0.05.SNP.above4x.maxmiss.8.imputed4.1.ld25-10-0.5 --aec 
```
move the files over
```{bash}
...
region_order <- c(
  ...
  "Cluster_6", "Cluster_14", "Cluster_11", "Cluster_10", "Cluster_13", "Cluster_15"
)
...
East_clusters    <- c("Cluster_6", "Cluster_14", "Cluster_11", "Cluster_10", "Cluster_13", "Cluster_15")
...
ggsave("BANS_overall_PCA_newcolor.png", width=8)
```
