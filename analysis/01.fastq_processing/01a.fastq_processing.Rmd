...
bcftools index --threads 16 vcf/BANS.all.ds6x.pass-maf-0.05.SNP.vcf.gz
```
...
java -Djava.io.tmpdir=/scratch/alpine/ericacnr@colostate.edu/tmp -Xmx37g -jar /curc/sw/install/bio/gatk/4.3.0.0/gatk-package-4.3.0.0-local.jar SelectVariants \
     ...
     -V $IN \
     -select-type SNP \
     --O $OUT/BANS.all.ds6x.pass-maf-0.05.SNP.vcf
...
java -Djava.io.tmpdir=/scratch/alpine/ericacnr@colostate.edu/tmp -Xmx37g \
  ...
  -R $REFERENCE \
  -V $OUT/BANS.all.ds6x.pass-maf-0.05.SNP.vcf \
  -O $OUT/BANS.all.ds6x_gatk.pass-maf-0.05.SNP.annot.vcf.gz \
...
-R $REFERENCE \
-V $OUT/BANS.all.ds6x_gatk.pass-maf-0.05.SNP.annot.vcf.gz \
...
vcftools --vcf BANS.all.ds6x_gatk.SNP.05maf.VQSR2.PASS.vcf --remove bad_ind --out BANS.all.ds6x.pass-maf-0.05.bialSNP.filtered.ind03miss.0.8miss --max-missing 0.8 --recode --recode-INFO-all

<!-- After filtering, kept 209 out of 229 Individuals -->
<!-- Outputting VCF file... -->
