...
```{bash}
vcftools --gzvcf ../BANS.all.ds6x.pass-maf-0.05.bialSNP.filtered.0.8miss.recode.vcf.gz --missing-indv
```
<!-- After filtering, kept 229 out of 229 Individuals -->
<!-- Outputting Individual Missingness -->
<!-- After filtering, kept 3085135 out of a possible 3085135 Sites -->

```{bash}
bcftools stats ../BANS.all.ds6x.pass-maf-0.05.bialSNP.filtered.0.8miss.recode.vcf.gz > BANS.all.ds6x.pass-maf-0.05.bialSNP.filtered.0.8miss.recode.stats.txt
```
<!-- SN    [2]id     [3]key                [4]value -->
<!-- SN      0       number of samples:      229 -->
<!-- SN      0       number of records:      3085135 -->
<!-- SN      0       number of no-ALTs:      0 -->
<!-- SN      0       number of SNPs: 3085135 -->
...
```{bash}
rsync -avzP ericacnr@colostate.edu@login.rc.colorado.edu:/scratch/alpine/ericacnr@colostate.edu/BANS/01.fastq_processing/mega-non-model-wgs-snakeflow/results/bqsr-round-0/vcf_final/eval/out.imiss /Users/ericarobertson/Desktop/BANS_adaptive_units/analysis/01.fastq_processing/
```
...
Well, the plate that I extracted has much lower missingness, and much less variable missingess. 209 individuals with low missingness is pretty good though.

So now I'm worried about batch effects. Quick PCA to evaluate...
