...
```{r, message=FALSE, warning=FALSE}
# Q_tibble <- read_table2("../admix-july-25/311ind-pass-maf05-snp-miss50-scafmt10-gtglimpute4.1-exclLD50-5-0.5-admix-K4-alpha0-r1.admix.4.Q",col_names = F) %>% rename(grp1=X1, grp2=X2, grp3=X3, grp4=X4)
# 
# #extract sample names in order from a plink file
# inds <- read_table("../pca/Apr-25/data/311ind-pass-maf05-snp-miss50-exclLD50-5-0.6.nosex", col_names =F) %>% rename(Sample=X1) %>% dplyr::select(-X2)
# 
